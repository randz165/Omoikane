...
public class CatalogoClaveUnidadSat extends JInternalFrame {
    ...
    {
        CatalogoClaveUnidadSat ca;
        boolean busquedaActiva = true;

        TimerBusqueda(CatalogoClaveUnidadSat ca) { this.ca = ca; }
        public void run()
        {
            synchronized(this)
            {
    ...
    public void setModoDialogo()
    {
        ...
        Action aceptar = new AbstractAction() { public void actionPerformed(ActionEvent e) {
            ((CatalogoClaveUnidadSat)e.getSource()).btnAceptar.doClick();
        } };
    ...
    private void initComponents() {
        ...
        setTitle("Catálogo de Unidades SAT");
        ...
        jLabel2.setText("<html><head><style type='text/css'>body { font-family: 'Roboto Thin'; font-size: 36px; }</style></head> <body> Catálogo de Unidades SAT </body></html>");
        ...
        tablaGrupos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Clave", "Nombre", "Descripcion", "Símbolo"
            }
        ) {
